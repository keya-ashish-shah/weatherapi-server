...
exports.getWeather = async (req, res) => {
  try {
    let { latitude, longitude, city } = { ...req.query, ...req.body };

    // DEBUG LOG (keep for now)
    console.log("Incoming:", { latitude, longitude, city });

    // CASE 1: city provided → geocode
    ...
    // CASE 2: neither city nor coordinates provided
